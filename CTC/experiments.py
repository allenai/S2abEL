...
#     parser.add_argument('--valid_fold', help='valid fold to use', type=str, default="img_class")
#     parser.add_argument('--test_fold', help='test fold to use', type=str, default='img_gen')
#     parser.add_argument('--pred_save_dir', help='the dir to save the predictions', type=str, default=None)
#     parser.add_argument('--input_file', help='the input file to use', type=str, required=True)
#     parser.add_argument('--model_path', help='the path to the model', type=str, required=True)
#     parser.add_argument('--seed', help='random seed', type=int, default=42)
#     parser.add_argument('--BS', help='evaluation batch size', type=int, default=512)
#     args = parser.parse_args()


#     exp = CTCEvalExp(seed=args.seed, test_fold=args.test_fold, input_file_path=args.input_file, model_path=args.model_path)
#     exp.generate_preds(save_path=args.pred_save_dir)
...
#     # for seed in (22, 32, 42, 52, 62):
#     #     for test_fold in ('qa', 'object_det', 'speech_rec', 'img_gen', 'mt', 'text_class', 'nli', 'pose_estim', 'sem_seg', 'misc'):
#     #         model_file = f'{test_fold}_BS=32_seed={seed}_epoch=2'
#     #         exp = CTCEvalExp(seed=seed, test_fold=test_fold, input_file_path='/net/nfs.cirrascale/s2-research/yuzel/tab-entity-link/data/axcell_inputs_new.pkl', model_path=f'/data/yuzel/models/paper_CTC/{model_file}')
#     #         exp.generate_preds(save_path=f'/data/yuzel/CTC_preds/{model_file}.pkl')
#             # val_f1, val_cr = exp.compute_cr('valid')
#             # test_f1, test_cr = exp.compute_cr('test')
#             # records.append({
#             #     'seed': seed,
#             #     'test_fold': test_fold,
#             #     'val_micro_f1': val_f1,
#             #     'val_other_f1': val_cr[2][0],
#             #     'val_dataset_f1': val_cr[2][1],
#             #     'val_method_f1': val_cr[2][2],
#             #     'val_metric_f1': val_cr[2][3],
#             #     'val_dataset_and_metric_f1': val_cr[2][4],
#             #     'val_other_p': val_cr[0][0],
#             #     'val_dataset_p': val_cr[0][1],
#             #     'val_method_p': val_cr[0][2],
#             #     'val_metric_p': val_cr[0][3],
#             #     'val_dataset_and_metric_p': val_cr[0][4],
#             #     'val_other_r': val_cr[1][0],
#             #     'val_dataset_r': val_cr[1][1],
#             #     'val_method_r': val_cr[1][2],
#             #     'val_metric_r': val_cr[1][3],
#             #     'val_dataset_and_metric_r': val_cr[1][4],
#             #     'test_micro_f1': test_f1,
#             #     'test_other_f1': test_cr[2][0],
#             #     'test_dataset_f1': test_cr[2][1],
#             #     'test_method_f1': test_cr[2][2],
#             #     'test_metric_f1': test_cr[2][3],
#             #     'test_dataset_and_metric_f1': test_cr[2][4],
#             #     'test_other_p': test_cr[0][0],
#             #     'test_dataset_p': test_cr[0][1],
#             #     'test_method_p': test_cr[0][2],
#             #     'test_metric_p': test_cr[0][3],
#             #     'test_dataset_and_metric_p': test_cr[0][4],
#             #     'test_other_r': test_cr[1][0],
#             #     'test_dataset_r': test_cr[1][1],
#             #     'test_method_r': test_cr[1][2],
#             #     'test_metric_r': test_cr[1][3],
#             #     'test_dataset_and_metric_r': test_cr[1][4]
#             # })
#     #         pbar.update(1)
#     # pbar.close()
#     # df = pd.DataFrame(records)
#     # df.groupby(by='test_fold').mean(numeric_only=True).to_csv('_analysis/CTC_ours_results.csv')
